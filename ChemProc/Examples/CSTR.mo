...
package CSTR "Example of Simulating a Continuous Stirred Tank Reactor"
  ...
  model MS "Extension of Material Stream with Raoult's Law"
    ...
    annotation(
      Documentation(info = "<html><head></head><body><span style=\"font-size: 12px;\">This is a non-executable model is created inside the package CSTR to extend the&nbsp;</span><a href=\"modelica://ChemProc.Streams.MaterialStream\">MaterialStream</a><span style=\"font-size: 12px;\">&nbsp;model along with the necessary property method from&nbsp;</span>ThermodynamicPackages<span style=\"font-size: 12px;\">&nbsp;which is&nbsp;</span><a href=\"modelica://ChemProc.Files.ThermodynamicPackages.RaoultsLaw\">RaoultsLaw</a><span style=\"font-size: 12px;\">&nbsp;in this case.</span><div><span style=\"font-size: 12px;\"><br></span></div><div>It will be instantiated in the&nbsp;<a href=\"modelica://ChemProc.Examples.CSTR.CSTRSimulation_Ex1\">CSTRSimulation_Ex1</a>&nbsp;&amp;&nbsp;<a href=\"modelica://ChemProc.Examples.CSTR.CSTRSimulation_Ex2\">CSTRSimulation_Ex2</a>&nbsp;models to create the required number of instances of the material stream model.</div></body></html>"));
  end MS;
  ...
  model CSTRSimulation_Ex1 "Calculation of reaction conversion from given kinetics during production of Ethylene Glycol by reacting Ethylene Oxide and Water in a CSTR"
    ...
    ChemProc.UnitOperations.CSTR B1(C = C, Mode = "Define_Out_Temperature", Nc = Nc, Pdel = 0, Phase = 1, Tdef = 350, V = 1) annotation(
      Placement(visible = true, transformation(origin = {1, -1}, extent = {{-17, -17}, {17, 17}}, rotation = 0)));
    ChemProc.Examples.CSTR.MS S1(C = C, Nc = Nc) annotation(
      Placement(visible = true, transformation(origin = {-50, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ChemProc.Examples.CSTR.MS S2(C = C, Nc = Nc) annotation(
  ...
  model CSTRSimulation_Ex2 "Calculation of reaction conversion from given kinetics during production of Methyl Acetate and Water by reacting Methanol and Acetic Acid in a CSTR"
    ...
    ChemProc.Examples.CSTR.MS S2(C = C, Nc = Nc) annotation(
      Placement(visible = true, transformation(origin = {54, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ChemProc.UnitOperations.CSTR B1(Af_r = {0.2}, BC_r = {1}, C = C, Coef_cr = {{-1}, {-1}, {1}, {1}}, DO_cr = {{1}, {0}, {0}, {0}}, Ef_r = {0}, Mode = "Define_Out_Temperature", Nc = Nc, Nr = 1, Pdel = 0, Phase = 3, Tdef = 360, V = 10) annotation(
