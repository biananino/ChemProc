...
package Absorption "Example of Simulating an Absorption Column"
  ...
  annotation(
      Documentation(info = "<html><head></head><body><span style=\"font-size: 12px;\">This is a non-executable model is created inside the package Absorption to extend the&nbsp;</span><a href=\"modelica://ChemProc.Streams.MaterialStream\">MaterialStream</a><span style=\"font-size: 12px;\">&nbsp;model along with the necessary property method from&nbsp;</span>ThermodynamicPackages<span style=\"font-size: 12px;\">&nbsp;which is&nbsp;</span><a href=\"modelica://ChemProc.Files.ThermodynamicPackages.RaoultsLaw\">RaoultsLaw</a><span style=\"font-size: 12px;\">&nbsp;in this case.</span><div><span style=\"font-size: 12px;\"><br></span></div><div>It will be instantiated in the&nbsp;<a href=\"modelica://ChemProc.Examples.Absorption.AbsorptionSimulation\">AbsorptionSimulation</a>&nbsp;model to create the required number of instances of the material stream model.</div></body></html>"));
  end MS;

  model Tray "Extension of Tray with Raoult's Law"
    extends ChemProc.UnitOperations.AbsorptionColumn.AbsTray;
    extends ChemProc.Files.ThermodynamicPackages.RaoultsLaw;
  annotation(
      Documentation(info = "<html><head></head><body><span style=\"font-size: 12px;\">This is a non-executable model is created inside the package Absorption to extend the&nbsp;</span><a href=\"modelica://ChemProc.UnitOperations.AbsorptionColumn.AbsTray\">Tray</a><span style=\"font-size: 12px;\">&nbsp;model along with the necessary property method from&nbsp;</span>ThermodynamicPackages<span style=\"font-size: 12px;\">&nbsp;which is&nbsp;</span><a href=\"modelica://ChemProc.Files.ThermodynamicPackages.RaoultsLaw\">RaoultsLaw</a><span style=\"font-size: 12px;\">&nbsp;in this case.</span><div><span style=\"font-size: 12px;\"><br></span></div><div>It will be instantiated in the&nbsp;<a href=\"modelica://ChemProc.Examples.Absorption.AbsColumn\">AbsColumn</a>&nbsp;model to create a complete absorption column model which will be instantiated in an executable model.</div></body></html>"));
  end Tray;

  model AbsColumn "Extension of Absorption COlumn with instance of Tray"
    extends ChemProc.UnitOperations.AbsorptionColumn.AbsCol(
    redeclare Tray tray[Nt](each Nc = Nc, each C = C));
  annotation(
      Documentation(info = "<html><head></head><body><span style=\"font-size: 12px;\">This is a non-executable model is created inside the package Absorption to extend the&nbsp;</span><a href=\"modelica://ChemProc.UnitOperations.AbsorptionColumn.AbsCol\">Absorption Column</a><span style=\"font-size: 12px;\">&nbsp;model along with the necessary property method from&nbsp;</span>ThermodynamicPackages<span style=\"font-size: 12px;\">&nbsp;which is&nbsp;</span><a href=\"modelica://ChemProc.Files.ThermodynamicPackages.RaoultsLaw\">RaoultsLaw</a><span style=\"font-size: 12px;\">&nbsp;in this case.</span><div><br></div><div>Tray model is also instantiated in this model to complete building of absorption column model.<br><div><span style=\"font-size: 12px;\"><br></span></div><div>It will be instantiated in the&nbsp;<a href=\"modelica://ChemProc.Examples.Absorption.AbsorptionSimulation\">AbsorptionSimulation</a>&nbsp;model to create the required instance of the absorption column model.</div></div></body></html>"));
  end AbsColumn;
