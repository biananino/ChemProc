...
package EquilibriumReactor "Example of Simulating an Equilibrium Reactor"
...
model MS "Extension of Material Stream with Raoult's Law"
  ...
  annotation(
      Documentation(info = "<html><head></head><body><span style=\"font-size: 12px;\">This is a non-executable model is created inside the package CR to extend the&nbsp;</span><a href=\"modelica://ChemProc.Streams.MaterialStream\">MaterialStream</a><span style=\"font-size: 12px;\">&nbsp;model along with the necessary property method from&nbsp;</span>ThermodynamicPackages<span style=\"font-size: 12px;\">&nbsp;which is&nbsp;</span><a href=\"modelica://ChemProc.Files.ThermodynamicPackages.RaoultsLaw\">RaoultsLaw</a><span style=\"font-size: 12px;\">&nbsp;in this case.</span><div><span style=\"font-size: 12px;\"><br></span></div><div>It will be instantiated in the&nbsp;<a href=\"modelica://ChemProc.Examples.EquilibriumReactor.EqReactorSimulation_Ex1\">EqReactorSimulation_Ex1</a>&nbsp;&amp;&nbsp;<a href=\"modelica://ChemProc.Examples.EquilibriumReactor.EqReactorSimulation_Ex2\">EqReactorSimulation_Ex2</a>&nbsp;models to create the required number of instances of the material stream model.</div></body></html>"));
end MS;

model EqReactorSimulation_Ex1 "Calculation of reaction conversion from equilibrium constant during production of Methanol by reacting Hydrogen and Carbonmonoxide in an Equilibrium Reactor"
 ...
 ChemProc.Examples.EquilibriumReactor.MS S1(Nc = Nc, C = C) annotation(
    Placement(visible = true, transformation(origin = {-108, 46}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  ChemProc.Examples.EquilibriumReactor.MS S2(Nc = Nc, C = C) annotation(
    Placement(visible = true, transformation(origin = {88, -46}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  ChemProc.UnitOperations.EquilibriumReactor B1(Basis = "Activity",C = C, Coef_cr = {{-2}, {-1}, {1}}, Kg = {0.5}, Mode = "Isothermal", Nc = Nc, Phase = "Vapour", Rmode = "ConstantK") annotation(
...
model EqReactorSimulation_Ex2 "Calculation of reaction conversion from equilibrium constant during production of Ethyl acetate by reacting Ethanol and Acetic Acid in an Equilibrium Reactor"
  ...
  ChemProc.Examples.EquilibriumReactor .MS S2(Nc = Nc, C = C) annotation(
    Placement(visible = true, transformation(origin = {88, -46}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  ChemProc.UnitOperations.EquilibriumReactor B1(C = C, Nc = Nc, Mode = "Adiabatic", Basis = "PartialPressure", Phase = "Vapour") annotation(
