...
package ShortcutColumn "Example of Simulating a Shortcut Column"
  ...
  model MS "Extension of Material Stream with Raoult's Law"
    ...
    annotation(
      Documentation(info = "<html><head></head><body><span style=\"font-size: 12px;\">This is a non-executable model is created inside the package ShortcutColumn to extend the&nbsp;</span><a href=\"modelica://ChemProc.Streams.MaterialStream\">MaterialStream</a><span style=\"font-size: 12px;\">&nbsp;model along with the necessary property method from&nbsp;</span>ThermodynamicPackages<span style=\"font-size: 12px;\">&nbsp;which is&nbsp;</span><a href=\"modelica://ChemProc.Files.ThermodynamicPackages.RaoultsLaw\">RaoultsLaw</a><span style=\"font-size: 12px;\">&nbsp;in this case.</span><div><span style=\"font-size: 12px;\"><br></span></div><div><span style=\"font-size: 12px;\">It will be instantiated in the&nbsp;</span><a href=\"modelica:///ChemProc.Examples.ShortcutColumn.ShortcutSimulation\" style=\"font-size: 12px;\">ShortcutSimulation</a><span style=\"font-size: 12px;\">&nbsp;model to create the required number of instances of the material stream model.</span></div></body></html>"));
  end MS;

  model Shortcut "Extension of Shortcut Column with Raoult's Law"
    extends ChemProc.UnitOperations.ShortcutColumn;
    extends ChemProc.Files.ThermodynamicPackages.RaoultsLaw;
    annotation(
      Documentation(info = "<html><head></head><body><span style=\"font-size: 12px;\">This is a non-executable model is created inside the package ShortutColumn to extend the&nbsp;</span><a href=\"modelica://ChemProc.UnitOperations.ShortcutColumn\">ShortcutColumn</a><span style=\"font-size: 12px;\">&nbsp;model along with the necessary property method from&nbsp;</span>ThermodynamicPackages<span style=\"font-size: 12px;\">&nbsp;which is&nbsp;</span><a href=\"modelica://ChemProc.Files.ThermodynamicPackages.RaoultsLaw\">RaoultsLaw</a><span style=\"font-size: 12px;\">&nbsp;in this case.</span><div><span style=\"font-size: 12px;\"><br></span></div><div><span style=\"font-size: 12px;\">It will be instantiated in the&nbsp;</span><a href=\"modelica://ChemProc.Examples.ShortcutColumn.ShortcutSimulation\" style=\"font-size: 12px;\">ShortcutSimulation</a><span style=\"font-size: 12px;\">&nbsp;model to create the required instance of the shortcut column model.</span></div></body></html>"));
  end Shortcut;
  ...
  model ShortcutSimulation "Calculation of minimum reflux and number of stages required in a fractionation column while separating a two component system"
    ...
    ChemProc.Examples.ShortcutColumn.MS S1(Nc = Nc, C = C) annotation(
      Placement(visible = true, transformation(origin = {-70, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ChemProc.Examples.ShortcutColumn.MS S3(Nc = Nc, C = C) annotation(
      Placement(visible = true, transformation(origin = {62, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ChemProc.Examples.ShortcutColumn.MS S2(Nc = Nc, C = C) annotation(
      Placement(visible = true, transformation(origin = {62, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    ChemProc.Examples.ShortcutColumn.Shortcut B1(Nc = Nc, C = C, HKey = 2, LKey = 1) annotation(
