...
model AdiabaticCompressor "Model of an adiabatic compressor to provide energy to vapor stream in form of pressure"
  extends ChemProc.Files.Icons.AdiabaticCompressor;
  
  extends ChemProc.Files.Models.Flash;
