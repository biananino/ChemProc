...
model HeatExchanger "Model of a heat exchanger used for two streams heat exchange"
  extends ChemProc.Files.Icons.HeatExchanger;
  ...
  parameter Integer Nc "Number of components" annotation(
    Dialog(tab = "Heat Exchanger Specifications", group = "Component Parameters"));
  ChemProc.Files.Interfaces.matConn In_Hot(Nc = Nc) annotation(
  ...
  ChemProc.Files.Interfaces.matConn Out_Hot(Nc = Nc) annotation(
  ...
  ChemProc.Files.Interfaces.matConn In_Cold(Nc = Nc) annotation(
  ...
  ChemProc.Files.Interfaces.matConn Out_Cold(Nc = Nc) annotation(
...
//=======================================================================================================
  for i in 1:Nc loop
    mu1[i] = ChemProc.Files.TransportProperties.LiqVis(C[i].LiqVis, (Tcin + Tcout) / 2);
    mu2[i] = ChemProc.Files.TransportProperties.LiqVis(C[i].LiqVis, (Thin + Thout) / 2);
    mu3[i] = ChemProc.Files.TransportProperties.LiqVis(C[i].LiqVis, (Tcin + Tcout) / 2);
    mu4[i] = ChemProc.Files.TransportProperties.LiqVis(C[i].LiqVis, (Thin + Thout) / 2);
  end for;
...
//==========================================================================================================
  for i in 1:Nc loop
    k1[i] = ChemProc.Files.TransportProperties.LiqK(C[i].LiqK, (Tcin + Tcout) / 2);
    k2[i] = ChemProc.Files.TransportProperties.LiqK(C[i].LiqK, (Thin + Thout) / 2);
    k3[i] = ChemProc.Files.TransportProperties.LiqK(C[i].LiqK, (Tcin + Tcout) / 2);
    k4[i] = ChemProc.Files.TransportProperties.LiqK(C[i].LiqK, (Thin + Thout) / 2);
  end for;
