...
model CentrifugalPump "Model of a centrifugal pump to provide energy to liquid stream in form of pressure"
  ...
  extends ChemProc.Files.Icons.CentrifugalPump;
...
//Calculation of Density
  for i in 1:Nc loop
    rho_c[i] = ChemProc.Files.ThermodynamicFunctions.Dens(C[i].LiqDen, C[i].Tc, Tin, Pin);
  end for;
