within ChemProc.BinaryPhaseEnvelope;
...
package NRTL
  ...
  model NRTLmodel
    ...
    parameter ChemProc.Files.ChemsepDatabase.GeneralProperties C[Nc] "Component instances array";
  ...
  model Txy
    ...
    parameter Real BIP[Nc, Nc, 2] = ChemProc.Files.ThermodynamicFunctions.BIPNRTL(Nc, C.CAS);
